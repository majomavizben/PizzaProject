                ...
                <div class="login-form bg-light border rounded mt-4 p-5">
                    ...
                    <div class="col-12 text-center pizzaLogo">Pizza<i class="fas fa-pizza-slice"></i>
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="Email" class="form-control" placeholder="E-mail cím" required>
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <input type="password" name="UserPass" class="form-control" placeholder="Jelszó újra" required>
                        </div>
                        <div class="col-12">
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12 text-center pizzaLogo">Van felhasználója?<i class=login></i>
                        </div>
                    </form>  
                </div>
            </div>
