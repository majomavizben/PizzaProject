...
<body>
    ...
    <header class="head">
        ...
        <nav class="navbar">
            ...
            <a href="#menu">Pizzáink</a>
            <a href="#kosar">Kosar</a>
            <a href="registration.php">Bejelentkezés/Regisztráció</a>
        </nav>
    </header>
    <!---------------------Rólunk----------------------------------------->
    ...
    <section class ="menu" id="menu">
        <h4>Mindig frissen!</h4>
        <div class="menu-content">
            <div class="in-box">
                <div class="tooltip">
                <img src="shourav-sheikh-a66sGfOnnqQ-unsplash.jpg" alt="">
                    <div class="in-content">
                        <span class="tooltipText">Összetevők: paradicsomos alap, sonka, sajt</span>
                            <h2>Sonkás pizza</h2>
                            <div class="description">Lorem ipsum dolor sit amet.</div>
                            <div class="price">2000Ft</div>
                            <a href="pizza_order_form.php">Rendelés</a>
                        </div>
                        </div>
                    </div>
            <div class="in-box">
                <img src="shourav-sheikh-a66sGfOnnqQ-unsplash.jpg" alt="">
                    <div class="in-content">
                        <span id="tooltipText">Összetevők: paradicsomos alap, sonka, sajt</span>
                            <h2>Sonkás pizza</h2>
                            <div class="description">Lorem ipsum dolor sit amet.</div>
                            <div class="price">2000Ft</div>
                            <a href="pizza_order_form.php">Rendelés</a>
        ...
        <!---------------------Kosár------------------------------------------>
        <section class="kosar" id="kosar">
            <h2>Fizetés a helyszínen</h2>
            <a href="admin.php">Admin felület</a>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iure labore quis aperiam. Velit, dolore suscipit?</p>
            </section>
</body>
<script>
