...
?>
	<div class="product-item">
		...
		<div class="product-price"><?php echo "$".$product_array[$key]["ar"]; ?></div>
...
<a id="btnEmpty" href="index.php?action=empty">Üres a kosár</a>
<?php
...
?>
<div class="no-records">Üres a kosarad</div>
<?php 
}
?>
</div>
